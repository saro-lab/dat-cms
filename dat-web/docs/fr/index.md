...
<div class="text-base font-bold"><a href="/fr/intro">Qu'est-ce que DAT ?</a></div>
<div class="text-sm">DAT (Distributed Access Token) est un token d'authentification distribuée (Session) qui réalise simultanément haute performance et sécurité.</div>
...
<div class="mt-3">
    ...
    <a href="/fr/svc/docker-saro-lab-dat-cms" class="mr-1.5 inline-block text-sm">
