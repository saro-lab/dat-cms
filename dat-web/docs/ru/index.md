...
<div class="text-base font-bold"><a href="/ru/intro">Что такое DAT?</a></div>
<div class="text-sm">DAT (Distributed Access Token) — это распределённый токен аутентификации (сессия), обеспечивающий одновременно высокую производительность и безопасность.</div>
...
<div class="mt-3">
    ...
    <a href="/ru/svc/docker-saro-lab-dat-cms" class="mr-1.5 inline-block text-sm">
