...
<div class="text-base font-bold"><a href="/es/intro">¿Qué es DAT?</a></div>
<div class="text-sm">DAT (Distributed Access Token) es un token de autenticación distribuido (Session) que logra simultáneamente alto rendimiento y seguridad.</div>
...
<div class="mt-3">
    ...
    <a href="/es/svc/docker-saro-lab-dat-cms" class="mr-1.5 inline-block text-sm">
