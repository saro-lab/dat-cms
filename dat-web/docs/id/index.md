...
<div class="text-base font-bold"><a href="/id/intro">Apa itu DAT?</a></div>
<div class="text-sm">DAT (Distributed Access Token) adalah token autentikasi terdistribusi (Session) yang mewujudkan performa tinggi dan keamanan secara bersamaan.</div>
...
<div class="mt-3">
    ...
    <a href="/id/svc/docker-saro-lab-dat-cms" class="mr-1.5 inline-block text-sm">
