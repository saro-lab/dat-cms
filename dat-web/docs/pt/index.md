...
<div class="text-base font-bold"><a href="/pt/intro">O que é DAT?</a></div>
<div class="text-sm">DAT (Distributed Access Token) é um token de autenticação distribuído (Session) que realiza simultaneamente alto desempenho e segurança.</div>
...
<div class="mt-3">
    ...
    <a href="/pt/svc/docker-saro-lab-dat-cms" class="mr-1.5 inline-block text-sm">
